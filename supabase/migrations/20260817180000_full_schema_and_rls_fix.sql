...
ALTER TABLE procedimentos ADD COLUMN IF NOT EXISTS especialidade TEXT;
ALTER TABLE procedimentos ADD COLUMN IF NOT EXISTS valor_padrao NUMERIC(10,2) DEFAULT 0;
ALTER TABLE procedimentos ADD COLUMN IF NOT EXISTS valor_coparticipacao NUMERIC(10,2) DEFAULT 0;
ALTER TABLE procedimentos ADD COLUMN IF NOT EXISTS observacoes TEXT;
...
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS celular_whatsapp TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS cidade TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS uf TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS cep TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS logradouro TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS numero TEXT;
ALTER TABLE credenciados ADD COLUMN IF NOT EXISTS bairro TEXT;
...
ALTER TABLE associados ADD COLUMN IF NOT EXISTS estado_civil TEXT;
ALTER TABLE associados ADD COLUMN IF NOT EXISTS profissao TEXT;
ALTER TABLE associados ADD COLUMN IF NOT EXISTS celular_whatsapp TEXT;
ALTER TABLE associados ADD COLUMN IF NOT EXISTS cep TEXT;
ALTER TABLE associados ADD COLUMN IF NOT EXISTS logradouro TEXT;
...
ALTER TABLE associados ADD COLUMN IF NOT EXISTS uf TEXT;
ALTER TABLE associados ADD COLUMN IF NOT EXISTS observacoes TEXT;
...
ALTER TABLE requisicoes ADD COLUMN IF NOT EXISTS associado_status TEXT;
ALTER TABLE requisicoes ADD COLUMN IF NOT EXISTS faturado BOOLEAN DEFAULT false;
ALTER TABLE requisicoes ADD COLUMN IF NOT EXISTS remessa_id UUID;
...
ALTER TABLE documentos_padroes ADD COLUMN IF NOT EXISTS descricao TEXT;
