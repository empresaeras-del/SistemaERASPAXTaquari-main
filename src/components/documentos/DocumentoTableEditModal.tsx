      ...
      <div className="bg-[#181d27] border border-[#2d3544] w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white leading-tight">
                Editor de Tabelas (modelo Office)
              </h3>
              <p className="text-xs text-slate-400 mt-0.5">
                Mescle, divida, redimensione e formate células como no Word/Excel
              </p>
            </div>
          </div>
          <button
        ...
        {tables.length === 0 ? (
          <div className="p-10 text-center text-slate-400 text-sm">
            Nenhuma tabela encontrada no conteúdo do documento. Use &quot;Tabelas &amp; Grades&quot;
            para inserir uma primeiro.
          </div>
        ) : (
          <>
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold shrink-0 transition-colors ${
                      i === selectedIdx
                        ...
                        : 'bg-[#1e2533] text-slate-400 border border-[#2d3544] hover:text-slate-200'
                    }`}
                  >
            ...
            <div className="px-5 py-3 border-b border-[#2d3544] bg-[#13171f] flex flex-wrap items-center gap-2 shrink-0">
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-[#1e2533] hover:bg-emerald-500/20 text-slate-200 hover:text-emerald-300 border border-[#2d3544] rounded-xl text-[11px] font-semibold transition-all flex items-center gap-1.5"
              >
              ...
              <button
                ...
                disabled={numRows <= 1}
                className="px-2.5 py-1.5 bg-[#1e2533] hover:bg-rose-500/20 disabled:opacity-30 text-slate-200 hover:text-rose-300 border border-[#2d3544] rounded-xl text-[11px] font-semibold transition-all flex items-center gap-1.5"
              >
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-[#1e2533] hover:bg-amber-500/20 text-slate-200 hover:text-amber-300 border border-[#2d3544] rounded-xl text-[11px] font-semibold transition-all flex items-center gap-1.5"
              >
                {table?.classList.contains('tabela-sem-grade') ? (
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  onClick={handleApplyColumnWidth}
                  className="px-2 py-1 bg-[#1e2533] hover:bg-indigo-500/20 text-slate-200 hover:text-indigo-300 border border-[#2d3544] rounded-lg text-[11px] font-semibold transition-all"
                >
                  Aplicar
                </button>
              </div>
              ...
              <div className="ml-auto">
                <button
                  ...
                  className="px-2.5 py-1.5 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-xl text-[11px] font-semibold transition-all flex items-center gap-1.5"
                >
            ...
            <div className="flex-1 overflow-auto p-6 bg-[#0f1219]">
                            ...
                            <td
                              ...
                              className={`border px-3 py-2 text-[11px] cursor-pointer align-top min-w-[70px] transition-colors ${
                                selected
                                  ...
                                  : 'border-[#2d3544] bg-[#181d27] text-slate-300 hover:bg-[#1e2533]'
                              }`}
                              style={{
                                backgroundColor: !selected
                                  ? ref.el.style.backgroundColor || undefined
                                  : undefined,
                              }}
                              title="Clique para selecionar · Shift+clique para selecionar um intervalo"
                            >
                              {ref.el.textContent?.trim() ? (
                                ref.el.textContent.trim().slice(0, 40)
                              ) : (
                                <span className="italic text-slate-500">(vazio)</span>
                              )}
                            </td>
                          );
                        })}
              ...
              <p className="text-center text-[10px] text-slate-500 mt-4">
                Clique em uma célula para selecioná-la · Shift+clique para selecionar um intervalo e
                mesclar
              </p>
            </div>
          </>
