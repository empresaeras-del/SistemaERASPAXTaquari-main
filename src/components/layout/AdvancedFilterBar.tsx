                ...
                <div className="border-t border-border-default p-3 bg-bg-surface">
                  {isSaving ? (
                    <div className="flex gap-2">
                      ...
                      />
                      <button type="button" onClick={saveFilter} className="p-1 bg-emerald-500 text-white rounded hover:bg-emerald-600">
                        <Check className="w-4 h-4" />
                      </button>
                      <button type="button" onClick={() => setIsSaving(false)} className="p-1 bg-bg-hover text-text-subtle rounded hover:text-text-base">
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                  ) : (
