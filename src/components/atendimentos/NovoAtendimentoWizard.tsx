    ...
    return associados
      .filter(
        (a) =>
          ...
          a.cpf?.includes(associadoSearch),
      )
      .slice(0, 10);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-bg-base/80 backdrop-blur-sm p-4">
      <div className="bg-bg-subtle rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col border border-border-default overflow-hidden">
        ...
        <div className="flex border-b border-border-default bg-bg-surface/50 overflow-x-auto">
          {['Dados do Falecido', 'Locais e Datas', 'Itens Funerários', 'Registros Financeiros'].map(
            (t, i) => {
              const stepNum = i + 1;
              ...
              return (
                <div
                  key={t}
                  className={`flex-1 py-3 px-4 text-center border-b-2 text-sm font-semibold transition-colors ${active ? 'border-primary text-primary' : past ? 'border-transparent text-text-base' : 'border-transparent text-text-muted'}`}
                >
                  <div className="flex items-center justify-center gap-2">
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${active ? 'bg-primary text-white' : past ? 'bg-emerald-500 text-white' : 'bg-bg-hover text-text-subtle'}`}
                    >
                  ...
                  {!selectedAssociado ? (
                        ...
                        {filteredAssociados.map((a) => (
                          ...
                          >
                            ...
                            <p className="text-xs text-text-subtle">
                              CPF: {a.cpf} | Plano: {a.plano_nome || 'Nenhum'}
                            </p>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-sm text-text-subtle">
                            Plano: {selectedAssociado.plano_nome || 'Não possui'}
                          </p>
                        </div>
                        <button
                      ...
                      <div className="space-y-3">
                        <p className="text-sm font-semibold text-text-base border-b border-primary/10 pb-2">
                        ...
                        <label className="flex items-center gap-3 p-2 hover:bg-bg-surface rounded-lg cursor-pointer">
                          <input
                            ...
                            name="falecido"
                            value="associado"
                            checked={falecidoId === 'associado'}
                            onChange={() => setFalecidoId('associado')}
                            className="text-primary"
                          />
                          <div>
                            <p className="font-medium text-text-base">
                              {selectedAssociado.nome} (Titular)
                            </p>
                            <p className="text-xs text-text-subtle">
                              CPF: {selectedAssociado.cpf} | Nasc:{' '}
                              {formatLocalDate(
                                selectedAssociado.data_nascimento,
                                'dd/MM/yyyy',
                                'N/I',
                              )}
                            </p>
                        ...
                        {selectedAssociado.dependentes?.map((d) => (
                          ...
                          >
                            <input
                              ...
                              name="falecido"
                              value={d.id}
                              checked={falecidoId === d.id}
                              onChange={() => setFalecidoId(d.id)}
                              className="text-primary"
                            />
                            <div>
                              ...
                              <p className="text-xs text-text-subtle">
                                CPF: {d.cpf || 'N/I'} | Nasc:{' '}
                                {formatLocalDate(d.data_nascimento, 'dd/MM/yyyy', 'N/I')}
                              </p>
                            </div>
                          </label>
                        ))}
              ...
              {tipoCliente === 'externo' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      type="date"
                      value={falecidoDataNascimento}
                      onChange={(e) => setFalecidoDataNascimento(e.target.value)}
                      className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                    />
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                ...
                <input
                  type="datetime-local"
                  value={dataVelorio}
                  onChange={(e) => setDataVelorio(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => setDataSepultamento(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
              ...
              <div className="md:col-span-2 pt-4 mt-2 border-t border-border-default">
                <p className="text-sm font-semibold text-text-base mb-3">
                  Dados Médicos e Declaração de Óbito{' '}
                  <span className="text-text-muted font-normal">
                    (opcional, pode ser completado depois)
                  </span>
                </p>
              </div>
              <div className="space-y-1">
                ...
                <select
                  value={sexoFalecido}
                  onChange={(e) => setSexoFalecido(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                >
              ...
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  value={corFalecido}
                  onChange={(e) => setCorFalecido(e.target.value)}
              ...
              <div className="space-y-1">
                ...
                <input
                  type="time"
                  value={horaObito}
                  onChange={(e) => setHoraObito(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  value={declaracaoObito}
                  onChange={(e) => setDeclaracaoObito(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  value={rqeMedico}
                  onChange={(e) => setRqeMedico(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
                ...
                <input
                  type="time"
                  value={inicioTanato}
                  onChange={(e) => setInicioTanato(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-text-subtle mb-1">
                  Término Tanatopraxia
                </label>
                <input
                  type="time"
                  value={terminoTanato}
                  onChange={(e) => setTerminoTanato(e.target.value)}
                  className="w-full px-4 py-2 bg-bg-surface border border-border-default rounded-xl text-text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
            </div>
                  ...
                  {itens
                    ...
                    .map((item) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className={`flex items-center justify-between p-3 rounded-xl border transition-colors ${isSelected ? 'bg-primary/5 border-primary/50' : 'bg-bg-base border-border-default'}`}
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-text-subtle">
                                Ref: R$ {item.valor_referencia?.toFixed(2) || '0.00'}
                              </p>
                            </div>
                          </div>
                          {isSelected && (
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateItemQuantidade(item.id, parseInt(e.target.value) || 1)
                                }
                ...
                <div className="p-4 border-b border-border-default bg-bg-subtle">
                  ...
                  {tipoCliente === 'associado' ? (
                    <p className="text-xs text-text-subtle mt-1">
                      Analisando cobertura do plano:{' '}
                      <span className="font-semibold text-primary">{currentPlano?.nome}</span>
                    </p>
                  ) : (
                    <p className="text-xs text-text-subtle mt-1">
                      Cliente Externo - Cobrança integral
                    </p>
                  )}
                </div>
                <div className="p-4">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border-default/50">
                        ...
                        <tr key={idx}>
                          ...
                          <td className="py-3 text-center">
                            {i.coberto ? (
                              ...
                              <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-rose-500/10 text-rose-500 border border-rose-500/20">
                                NÃO COBERTO
                              </span>
                            )}
                          </td>
                      ...
                      {financeiro.itemsProcessed.length === 0 && (
                        <tr>
                          <td colSpan={5} className="py-4 text-center text-text-subtle">
                    ...
                    <tfoot className="border-t-2 border-border-default">
                      <tr>
                        <td colSpan={4} className="py-4 text-right text-text-subtle font-medium">
                          Total do Atendimento
                        </td>
                        <td className="py-4 text-right text-text-base font-bold">
                          R$ {(financeiro.totalCovered + financeiro.totalUncovered).toFixed(2)}
                        </td>
                      </tr>
                      <tr>
                        <td colSpan={4} className="py-2 text-right text-text-subtle font-medium">
                          Total Coberto pelo Plano
                        </td>
                        <td className="py-2 text-right text-emerald-500 font-bold">
                          R$ {financeiro.totalCovered.toFixed(2)}
                        </td>
                      </tr>
                      <tr>
                        <td colSpan={4} className="py-2 text-right text-text-base font-bold">
                          Valor a Cobrar (Gerar Receita)
                        </td>
                        <td className="py-2 text-right text-rose-500 font-black text-lg">
                          R$ {financeiro.totalUncovered.toFixed(2)}
                        </td>
                      </tr>
                    </tfoot>
                  </table>
          ...
          <div className="bg-bg-surface border border-border-default rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col p-6 space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-text-subtle">Regra Global de Atendimento Funerário</p>
              </div>
            </div>
                ...
                {statusQuestionData.isTitular ? (
                  <>
                    ...
                    <strong className="text-primary font-bold">
                      {statusQuestionData.associado.nome}
                    </strong>{' '}
                  ...
                  <>
                    ...
                    <strong className="text-primary font-bold">
                      {statusQuestionData.dependente?.nome}
                    </strong>{' '}
                    {statusQuestionData.dependente?.parentesco &&
                      `(${statusQuestionData.dependente.parentesco})`}{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                type="button"
                onClick={
                  statusQuestionData.isTitular ? handleInativarTitular : handleInativarDependente
                }
              ...
              >
                {inactivating ? (
                  ...
                  <>
                    ...
                    {statusQuestionData.isTitular
                      ? 'Sim, Inativar Titular'
                      : 'Sim, Inativar Dependente'}
                  </>
                )}
              </button>
