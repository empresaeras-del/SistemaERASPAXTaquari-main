...
find_buttons = """        <button onClick={() => navigate('/financeiro/contas-a-receber/nova')} className="flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-xl font-medium transition-colors shadow-lg shadow-emerald-500/20">"""
